# 🚀 Docu-Dive: Full-Stack RAG Web App
...
Hi there! Welcome to my project, **Docu-Dive**. I built this full-stack application to showcase my skills in integrating Modern Web Technologies with Generative AI. 

Docu-Dive is a multi-document search platform that uses **Retrieval-Augmented Generation (RAG)**. It allows users to query information across multiple uploaded documents and get answers generated by AI, demonstrating practical applications of Large Language Models (LLMs).
